...
export default function SignUp() {
  ...
  return (
    <div className="body bg-slate-50 text-black flex flex-col md:flex-row min-h-screen md:h-screen w-screen">
      ...
      {/* Left side: Form */}
      <div className="flex flex-col justify-start gap-8 p-6 md:p-8 w-full md:w-[60%] md:px-52">
        <Link href="/">
        ...
        <h2 className='text-xl text-neutral-950 font-bold'>Login to your account</h2>
        ...
        <div className="form bg-white text-gray-400">
          ...
          <p className='text-center mt-4 text-gray-600'>Don't have an account? Sign up</p>
          </Link>
        </div>
      </div>
